...
import { Mail, Phone, MapPin, Linkedin, GraduationCap, Briefcase, Award, Smartphone, Globe } from 'lucide-react'; // Added Smartphone and Globe icons// Added 'Award' icon
...
// --- NEW Services Component (The main section) ---
function Services() {
  return (
    <section id="services" className="section">
      <div className="section-header">
        <h2 className="section-title">Services</h2>
        {/* Optional Subtitle: <p className="section-subtitle">What I offer to help your business grow.</p> */}
      </div>
...
export default function App() {
  const resumeData = {
    ...
    education: {
      ...
      institution: "kumaraguru collage of Technology",
      years: "2021 - 2025",
...
// ----------------------------------------------------------------
  ...
  // --- Certification Data Object (MODIFIED to include more context) ---
    ...
    <div className="portfolio-container">
      ...
      <main className="main-content">
        <div className="container">
          ...
          {/* NEW About Section (combining Education, Internship, and Certification) */}
          <section id="about" className="section">
            ...
            <div className="experience-card">
              <div className="experience-header">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{resumeData.education.institution} | {resumeData.education.years}</p>
                </div>
              </div>
            ...
            {/* NEW: Certification Detail (Replaced the visual banner) */}
            <div className="experience-card mt-6">
              <div className="experience-header">
                <Award size={24} className="text-amber-400" />
                <div>
                  <h3>{certificationData.title}</h3>
                  <p className="text-gray-400">{certificationData.issuer} | {certificationData.duration}</p>
                </div>
              </div>
